...
class ANNTrainer:
    ...
    def __init__(self, model, train_loader, test_loader, criterion=nn.CrossEntropyLoss(), lr=0.01,
        ...
        self.model = model.to(self.device)  # Pindahkan model ke device (CPU/GPU)
        self.train_loader = train_loader
        self.test_loader = test_loader
        self.criterion = criterion.to(self.device)  # Pindahkan loss function ke device
    ...
    def test(self):
        ...
        with torch.no_grad():
            for images, labels in self.test_loader:
                ...
                all_preds.extend(predicted.cpu().numpy())  # Kembalikan ke CPU untuk evaluasi
